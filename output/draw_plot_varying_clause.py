...
marker=['x','o',"v",'*','s',"p",'D','^']
x = [1,2,3]
df = pd.read_csv('vary_clause',header=-1, sep='\s+',)
...
pylab.xlabel(r"$\#$"+ "clause, "+r"$k$",fontsize=fontsize)
...
if(show):
	pylab.show()
pylab.savefig("test_accuracy_vary_clause.pdf")
pylab.clf()
...
if(show):
	pylab.show()
pylab.savefig("train_accuracy_vary_clause.pdf")
pylab.clf()
...
if(show):
	pylab.show()
pylab.savefig("time_vary_clause.pdf")
pylab.clf()
...
if(show):
	pylab.show()
pylab.savefig("rule_size_vary_clause.pdf")
pylab.clf()
